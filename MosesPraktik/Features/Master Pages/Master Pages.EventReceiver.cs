...
namespace MosesPraktik.Features.Master_Pages
{
    /// <summary>
    ...
    [Guid("ccbc0497-a702-48a1-b06e-d0e21065ac53")]
    public class Master_PagesEventReceiver : SPFeatureReceiver
    {
        public override void FeatureActivated(SPFeatureReceiverProperties properties)
        {
            ...
            if (site != null)
            {
                ...
                foreach (SPWeb web in site.AllWebs)
                {
                    ...
                    web.MasterUrl = webAppRelativePath + "_catalogs/masterpage/ListPage.master";
                    web.CustomMasterUrl = webAppRelativePath + "_catalogs/masterpage/ListPage.master";
